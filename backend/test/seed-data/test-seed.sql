-- ============================================================================
--  QuanLyDanCu seed data (aligned with simplified schema - November 2025)
--  Usage: psql -h <host> -U <user> -d quanlydancu -f test-seed.sql
-- ============================================================================

-- ---------------------------------------------------------------------------
-- Reset tables (respect FK order)
-- ---------------------------------------------------------------------------
...
('Trần Thị Bích',      '1988-08-15', 'Nu',  'Kinh', 'Việt Nam', 'Giáo viên',      '001088002345', '2012-06-05', 'Công an TP.HCM', 'Vợ',      NULL, NULL, NULL, NULL, NULL, 1),
('Nguyễn Văn Cường',  '2013-03-20', 'Nam', 'Kinh', 'Việt Nam', 'Học sinh',       NULL,            NULL,        NULL,              'Con',     NULL, NULL, NULL, NULL, NULL, 1),
('Nguyễn Ngọc Lan',    '2018-11-02', 'Nu',  'Kinh', 'Việt Nam', 'Học sinh',       NULL,            NULL,        NULL,              'Con',     'Yêu thích hội họa', NULL, NULL, NULL, NULL, 1),
-- HK002
...
('Lê Thị Dung',        '1958-06-10', 'Nu',  'Kinh', 'Việt Nam', 'Nội trợ',        '001058004567', '2011-04-18', 'Công an TP.HCM', 'Vợ',     NULL, NULL, NULL, NULL, NULL, 2),
...
('Nguyễn Thị Phương',  '1992-02-20', 'Nu',  'Kinh', 'Việt Nam', 'Y tá',           '001092006789', '2016-07-01', 'Công an TP.HCM', 'Con dâu', NULL, NULL, NULL, '2025-05-01', '2025-12-31', 2),
-- HK003
('Lê Thị Cúc',         '1975-04-12', 'Nu',  'Kinh', 'Việt Nam', 'Công nhân',      '001075007890', '2013-01-08', 'Công an TP.HCM', 'Chủ hộ', NULL, NULL, NULL, NULL, NULL, 3),
...
('Lê Văn Phúc',        '2002-07-18', 'Nam', 'Kinh', 'Việt Nam', 'Sinh viên',      '001002009012', '2020-08-20', 'Công an TP.HCM', 'Con',    'Thực tập tại Đà Nẵng', '2025-05-10', '2025-08-30', NULL, NULL, 3),
('Lê Thị Quỳnh',       '2007-11-25', 'Nu',  'Kinh', 'Việt Nam', 'Học sinh',       NULL,            NULL,        NULL,              'Con',    NULL, NULL, NULL, NULL, NULL, 3),
-- HK004
...
('Hoàng Thị Giang',    '1972-11-30', 'Nu',  'Kinh', 'Việt Nam', 'Kế toán',        '001072010234', '2014-05-03', 'Công an TP.HCM', 'Vợ',     NULL, NULL, NULL, NULL, NULL, 4),
('Phạm Thị Hoa',       '1948-03-05', 'Nu',  'Kinh', 'Việt Nam', 'Về hưu',         '001048011345', '2005-02-01', 'Công an Hà Nội', 'Mẹ',     'Thường xuyên khám định kỳ', NULL, NULL, NULL, NULL, 4),
...
('Trần Thị Khánh',     '1982-05-15', 'Nu',  'Kinh', 'Việt Nam', 'Buôn bán nhỏ',   '001082014678', '2012-10-07', 'Công an TP.HCM', 'Vợ',     NULL, NULL, NULL, NULL, NULL, 5),
...
('Hoàng Thị Mai',      '2010-11-25', 'Nu',  'Kinh', 'Việt Nam', 'Học sinh',       NULL,            NULL,        NULL,              'Con',    NULL, NULL, NULL, NULL, NULL, 5),
-- HK006
('Võ Thị Phượng',      '1992-04-18', 'Nu',  'Kinh', 'Việt Nam', 'Nhân viên văn phòng', '001092016890', '2018-03-19', 'Công an TP.HCM', 'Chủ hộ', NULL, NULL, NULL, NULL, NULL, 6),
...
('Võ Gia Chi',         '2020-07-14', 'Nu',  'Kinh', 'Việt Nam', 'Trẻ em',         NULL,            NULL,        NULL,              'Con',     'Thích truyện tranh', NULL, NULL, NULL, NULL, 6),
-- HK007
...
('Nguyễn Thị Hiền',    '1989-10-30', 'Nu',  'Kinh', 'Việt Nam', 'Điều dưỡng',     '001089019123', '2015-09-10', 'Công an TP.HCM', 'Vợ',     NULL, NULL, NULL, NULL, NULL, 7),
('Đỗ Trần Khoa',       '2014-04-08', 'Nam', 'Kinh', 'Việt Nam', 'Học sinh',       NULL,            NULL,        NULL,              'Con',    NULL, NULL, NULL, NULL, NULL, 7),
-- HK008
('Bùi Thị Hương',      '1986-12-08', 'Nu',  'Kinh', 'Việt Nam', 'Dược sĩ',        '001086020134', '2010-09-09', 'Công an TP.HCM', 'Chủ hộ', NULL, NULL, NULL, NULL, NULL, 8),
...
('Bùi Thị Mai',        '2015-09-25', 'Nu',  'Kinh', 'Việt Nam', 'Học sinh',       NULL,            NULL,        NULL,              'Con',    NULL, NULL, NULL, NULL, NULL, 8);
...
-- ---------------------------------------------------------------------------
-- Fee records: intentionally left empty (calculated dynamically in backend)
-- ---------------------------------------------------------------------------
-- INSERT INTO thu_phi_ho_khau (...) VALUES ...;

-- ---------------------------------------------------------------------------
-- Change logs: intentionally empty (operators can append later)
-- ---------------------------------------------------------------------------
-- INSERT INTO bien_dong (...) VALUES ...;
